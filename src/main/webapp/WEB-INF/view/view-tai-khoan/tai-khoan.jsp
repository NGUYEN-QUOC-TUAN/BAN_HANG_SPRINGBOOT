            ...
            <div class="col-6">
                <form method="post" action="/view-tai-khoan/add">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="ma" value="${taiKhoan.ma}">
                        <label>MA</label>
                    </div>
                    <div class="form-floating mb-3">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="soDienThoai" value="${taiKhoan.soDienThoai}">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="taiKhoan" value="${taiKhoan.taiKhoan}">
                        <label>TAI_KHOAN</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="matKhau" value="${taiKhoan.matKhau}">
